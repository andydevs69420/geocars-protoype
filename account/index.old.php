    ...
    <div class="central-wrapper">
        ...
        <div class="safe-area">
            <div class="account-wrapper">
                ...
                <!-- cover picture -->
                <photo id="cover-image" class="profile-cover">
                ...
                <!-- information tray -->
                <div class="information-tray">

                    <!-- col 1 -->
                    <span class="column">
                        <span id="total-cars-value" class="column-data" role="text">0</span>
                        <span class="column-label" role="text">Cars</span>
                    </span>

                    <!-- col 2 -->
                    <span class="column">
                        <span id="total-canceled-customer-value" class="column-data" role="text">0</span>
                        <span class="column-label" role="text">Canceled</span>
                    </span>

                    <!-- col 3 -->
                    <span class="column">
                        <span id="total-customer-value" class="column-data" role="text">0</span>
                        <span class="column-label" role="text">Customers</span>
                    </span>
                ...
                */
                ...
                switch (response.statusCode) {
                    ...
                    case 69: {
                        ...
                        dp_ptag.attr(
                            "src" ,
                            response.data.dp_link
                        );

                        cover_ptag.attr(
                            "src" ,
                            response.data.cover_link
                        );
